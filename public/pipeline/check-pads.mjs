...
await p.mouse.move(q.x,q.y); await p.mouse.down(); await p.mouse.move(q.x+70,q.y+50,{steps:14}); await p.mouse.up();
...
await p.mouse.move(q.x,q.y); await p.mouse.down(); await p.mouse.move(q.x+120,q.y+40,{steps:14}); await p.mouse.up();
await p.waitForTimeout(300);
B=await band(1);
...
await p.mouse.move(q.x,q.y); await p.mouse.down(); await p.mouse.move(q.x-80,q.y-60,{steps:14}); await p.mouse.up();
await p.waitForTimeout(300);
B=await band(1);
