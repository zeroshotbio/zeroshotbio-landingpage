...
{id:"A1", key:"A1", group:"Breeding", shape:"breedingtank", name:"Pair set in the evening", x:4.3, y:R1, w:0.72, d:0.72, h:0.62,
...
{id:"A2", key:"A2", group:"Breeding", shape:"clutch", name:"The clutch", x:5.7, y:R1, w:1.0, d:1.0, h:0.22,
...
{id:"A3", key:"A3", group:"Breeding", shape:"culldish", name:"Cull the unfertilised", x:7.1, y:R1, w:1.0, d:1.0, h:0.24,
...
{id:"A4", key:"A4", group:"Breeding", shape:"tile", name:"Stage and array", x:8.5, y:R1, w:0.72, d:0.72, h:0.42,
 ...
 built:"Confirmed for the worked example, not assumed: 48 wells and 6 embryos per well are in the MegaFIN 100k column of the design spec, and split-pipe's own run definition independently agrees — round-one barcode set n141_R1_v3_8 is described as '96 barcodes, 48 wells; rows A-D, cols 1-12'.",
...
{id:"A7", key:"A7", group:"Collection", shape:"tile", name:"Collect and fix", x:16.0, y:R1, w:0.72, d:0.72, h:0.46,
...
/* ================= ROW 2 — THE CHEMISTRY ================= */
{id:"B0", key:"B1", group:"Combinatorial barcoding", shape:"tile", name:"Count and loading table", x:0.7, y:R2, w:0.72, d:0.72, h:0.44,
...
{id:"R1p", key:"B2", group:"Combinatorial barcoding", shape:"miniplate", name:"Round 1 — reverse transcription", x:2.6, y:R2, w:1.0, d:0.8, h:0.3, cols:12, rows:4,
...
{id:"B1", key:"B3", group:"Combinatorial barcoding", shape:"tile", name:"Pool and split", x:4.2, y:R2, w:0.6, d:0.6, h:0.3,
...
{id:"R2p", key:"B4", group:"Combinatorial barcoding", shape:"miniplate", name:"Round 2 — ligation", x:5.8, y:R2, w:1.0, d:0.8, h:0.3, cols:12, rows:8,
 ...
 cond:"Clean."},
{id:"B2", key:"B5", group:"Combinatorial barcoding", shape:"tile", name:"Pool and split", x:7.4, y:R2, w:0.6, d:0.6, h:0.3,
 sub:"shuffle again",
 does:"Pooled and redistributed a second time.",
 built:"Pool, mix, redistribute.", cond:"Clean."},
{id:"R3p", key:"B6", group:"Combinatorial barcoding", shape:"miniplate", name:"Round 3 — ligation", x:9.0, y:R2, w:1.0, d:0.8, h:0.3, cols:12, rows:8,
...
{id:"SB", key:"B7", group:"Combinatorial barcoding", shape:"tile", name:"Split into sublibraries, lyse", x:10.8, y:R2, w:0.85, d:0.85, h:0.55,
 sub:"8 sublibraries",
...
{id:"R4p", key:"B8", group:"Combinatorial barcoding", shape:"tile", name:"Round 4 — sublibrary index", x:12.4, y:R2, w:0.72, d:0.72, h:0.42,
...
{id:"IN", key:"G2", group:"Getting to a matrix", shape:"tile", hatch:true, name:"Intron inclusion", x:6.8, y:R3, w:0.68, d:0.68, h:0.36,
...
{id:"cb4", key:"C7", group:"Getting to a matrix", shape:"tile", name:"Combine and stamp", x:9.3, y:R3, w:0.68, d:0.68, h:0.45,
 sub:"one index",
...
{id:"c1", key:"D2", group:"The cull", shape:"tile", hatch:true, name:"Cell or background", x:15.4, y:R3, w:0.7, d:0.7, h:0.78,
...
{id:"c2", key:"D3", group:"The cull", shape:"tile", hatch:true, name:"Depth floor", x:16.6, y:R3, w:0.7, d:0.7, h:0.52,
...
{id:"c3", key:"D4", group:"The cull", shape:"tile", hatch:true, name:"Mitochondrial fraction", x:17.8, y:R3, w:0.7, d:0.7, h:0.5,
...
{id:"c4", key:"D5", group:"The cull", shape:"tile", hatch:true, name:"Outliers off the trend", x:19.0, y:R3, w:0.7, d:0.7, h:0.62,
...
{id:"hx", key:"G3", group:"The cull", shape:"tile", hatch:true, name:"Sample demultiplex", x:20.0, y:R3, w:0.7, d:0.7, h:0.46,
...
{id:"c5", key:"D6", group:"The cull", shape:"tile", hatch:true, name:"Doublets", x:21.0, y:R3, w:0.7, d:0.7, h:0.44,
...
<p><mark>Row 1 — the fish.</mark> Aquarium to fixed material. The only row where biology is being done rather than described. It ends on the fork that governs everything after it: whole cells, or nuclei.</p>
