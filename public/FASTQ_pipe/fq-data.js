...
{id:"UD", key:"E8", group:"② Unfiltered DGE", groupMark:true, anchor:true, shape:"dge", noclip:true,
 lane:"r3", gap:1.6,
 name:"Unfiltered DGE", x:37.0, y:R3, w:9.6, d:16.0, h:3.4,
...
const BANDS = [
  {name:"Bioinformatics pipeline", x0:-2.0, x1:70.0, y0:R3-9.6, y1:R3+16.8},
];
