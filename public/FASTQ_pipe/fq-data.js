...
{id:"FQ", key:"3", group:"③ FASTQ", groupMark:true, anchor:true, shape:"heap",
 lane:"r3",
 name:"FASTQ", x:1.0, y:R3, w:4.0, d:4.0, h:1.1,
 ...
 added:"Drawn as a heap rather than as a cube because that is what it is: eight sublibraries of paired files with no shared schema and no index. It is the one object on this page that cannot be opened — the payload on the track leaving it is the vendor's sequencing statistics, because the reads those statistics describe are not here."},
...
<p>Each station is a building whose height is roughly what it does per read, and the tallest is the aligner. The tracks between them carry the object that actually moves: reads out of the heap, a reference into the aligner, barcodes into the cube. Click a dot to read what is in transit.</p>`,
