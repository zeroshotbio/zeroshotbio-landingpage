...
{id:"QCD", key:"B9", group:"cDNA capture and amplification", shape:"quantify", name:"Quantify the cDNA", x:14.1, y:R2, lane:"r2", w:0.72, d:0.72, h:0.4,
 ...
 does:"Necessary? I think we can delete:NEEDS REVIEW. Concentration and fragment-size distribution are measured. This isn't bookkeeping — the concentration recorded here is what sets the number of PCR cycles in the indexing reaction three steps along. Too few cycles and the library is too thin to sequence; too many and it over-amplifies.",
...
{id:"SEQ", key:"S", group:"The sequencer", shape:"machine",
 ...
 does:"The sequencer reads both what each cell was expressing and the molecular address that tells us which cell each transcript came from.\nEach library molecule is read from both ends. Read 1 reads the cDNA insert — the biological sequence that identifies the expressed transcript. Read 2 reads Barcodes 1–3 and the UMI, while the i5/i7 index reads capture Barcode 4, identifying the sublibrary. Together, these sequences link each measured transcript back to an individual cell while the UMI helps distinguish independently captured molecules from PCR copies. For this experiment, we generated 3.66 billion reads across 16 sublibraries — about 38,600 reads per called cell — providing deep coverage of the cellular transcriptomes.",
