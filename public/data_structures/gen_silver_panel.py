...
MULTI=[
 ...
 ("farnsworth/","#4FBF5C","44,020 cells at 1, 2 and 5 dpf under 220 named clusters",
   [("zebrafish-dev/","the UCSC Cell Browser release — the paper deposits raw reads only"),
    ("Paper/","article + 7 supplements, downloaded by hand; PMC blocks scripts")],
   [("zebrafish-dev/exprMatrix.tsv.gz","32,520 genes x 44,020 cells; the origin's own md5 agrees"),
    ...
    ("Paper/NIHMS1545987-supplement-7.xlsx","Table S2 — germ layer/tissue/cell type, all 221 clusters")]),
