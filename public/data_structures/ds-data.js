...
{id:"BPUB", key:"2d", group:"② Bronze → Silver", shape:"cell", tier:"bronze", state:"live",
 ...
 kv:[["Command","uv run zsb-bronze minifin publish"],["Wrote","minifin/v1/, v2/, v3/"],["Ran","2026-08-23 · 2026-08-28 ×2"],["v1","1,562,739,920 B · parse-cutoffs"],["v2","1,559,526,002 B · parse-settings"],["v3","1,583,429,276 B · barcode-ranks"],["Ledger","rewritten last, all three times"],["Delete path","none"]]},
...
{id:"SILVER", key:"4", group:"④ Silver", groupMark:true, anchor:true,
 ...
 panel:"<style>.fkw{margin:.3rem 0 0;font-family:var(--mono,ui-monospace,monospace);font-size:clamp(9px,calc(var(--reader-w,360px)*0.0145),12px)}.fkl{display:flex;flex-direction:column;gap:.2rem;margin:.1rem 0 .55rem;font-size:clamp(9px,calc(var(--reader-w,360px)*0.014),11.5px);color:var(--fg2)}.fkl b{display:flex;align-items:center;gap:.45rem;font-weight:400}.fkl i{width:1.9em;height:.8em;border-radius:2px;flex:0 0 auto}.fkds{border:2px solid var(--acc);border-radius:5px;overflow:hidden;margin-bottom:1rem}.fkds h5{margin:0;padding:.4em .6em;font-family:var(--sans,system-ui);font-size:1.15em;font-weight:700;color:var(--acc);background:color-mix(in srgb,var(--acc) 12%,transparent);display:flex;justify-content:space-between;align-items:baseline;gap:.5em}.fkds h5 s{text-decoration:none;font-size:.62em;font-weight:600;opacity:.75}.fkg{display:flex;align-items:stretch;border-top:1px solid var(--rule,#2a2a2e)}.fkgl{flex:0 0 1.5em;display:flex;align-items:center;justify-content:center;writing-mode:vertical-rl;rotate:180deg;font-size:.62em;font-weight:700;letter-spacing:.06em;text-transform:uppercase;overflow:hidden;white-space:nowrap}.fkr{flex:1 1 auto;min-width:0}.fk{display:grid;grid-template-columns:minmax(0,1.3fr) 4.4em minmax(0,1.1fr);gap:0 .7em;padding:.16em .5em;line-height:1.5;border-left:2px solid transparent;align-items:baseline}.fk .p{white-space:pre;overflow:hidden;text-overflow:ellipsis}.fk .n{text-align:right;font-variant-numeric:tabular-nums;opacity:.85}.fk .t{font-family:var(--sans,system-ui);font-size:.88em;opacity:.55;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.fk.d1 .p{font-size:1.12em;font-weight:700}.fk.d2{opacity:.82}.fk.d2 .p{font-size:.94em}.fk.d3{opacity:.68}.fk.d3 .p{font-size:.88em}.fkh{font-size:.76em;letter-spacing:.09em;text-transform:uppercase;opacity:.45;border-bottom:1px solid var(--rule,#2a2a2e);padding:.3em .6em}</style><div class=\"fkl\"><b><i style=\"background:linear-gradient(90deg,#4FCB8A 0 50%,rgba(79,203,138,.13) 50%)\"></i>Published release — written here by zsb-bronze under the version convention</b><b><i style=\"background:linear-gradient(90deg,#6FA8E8 0 50%,rgba(111,168,232,.13) 50%)\"></i>Acquired source — taken verbatim from a public origin, custody in zsb-bronze</b><b><i style=\"background:linear-gradient(90deg,#8A8A92 0 50%,rgba(138,138,146,.13) 50%)\"></i>Predates the repos — written by neither, never versioned</b><b><i style=\"background:linear-gradient(90deg,#E8A33F 0 50%,rgba(232,163,63,.13) 50%)\"></i>Analysis working set — not a published artifact</b><b><i style=\"background:linear-gradient(90deg,#B07AA1 0 50%,rgba(176,122,161,.13) 50%)\"></i>Legacy flat keys — the retired pipeline's output, provenance in sidecars</b></div><div class=\"fkds\" style=\"--acc:#C08552\"><h5>megafin/<s>5 obj · 56.16 GiB · 58.5%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">CHANGELOG.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"the ledger, rewritten last on every publish\">the ledger, rewritten last on every publish</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v1/</span><span class=\"n\">27.99</span><span class=\"t\" title=\"megafin.h5ad + README — 2 objects\">megafin.h5ad + README — 2 objects</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v2/</span><span class=\"n\">28.17</span><span class=\"t\" title=\"megafin.h5ad + README — 2 objects\">megafin.h5ad + README — 2 objects</span></div></div></div><div class=\"fkds\" style=\"--acc:#7FB5A8\"><h5>chemfish/<s>9 obj · 20.04 GiB · 20.9%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">2025_03_release/</span><span class=\"n\">20.04</span><span class=\"t\" title=\"the authors’ March 2025 publication, held verbatim\">the authors’ March 2025 publication, held verbatim</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── RDS_Data/</span><span class=\"n\">20.03</span><span class=\"t\" title=\"7 objects — 6 data files + the authors’ SHA256SUMS\">7 objects — 6 data files + the authors’ SHA256SUMS</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── chemfish_cds.tar</span><span class=\"n\">19.95</span><span class=\"t\" title=\"sealed BPCells cds tarball\">sealed BPCells cds tarball</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── pectoral_fin_WT_cds.tar</span><span class=\"n\">0.07</span><span class=\"t\" title=\"sealed BPCells cds tarball\">sealed BPCells cds tarball</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── chemfish_DEGs.RDS</span><span class=\"n\">0.01</span><span class=\"t\" title=\"author result table\">author result table</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── Paper/</span><span class=\"n\">0.01</span><span class=\"t\" title=\"the bioRxiv preprint — supplements were published as data, not documents\">the bioRxiv preprint — supplements were published as data, not documents</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"origin, DOI, and the do-not-re-fetch warning\">origin, DOI, and the do-not-re-fetch warning</span></div></div></div><div class=\"fkds\" style=\"--acc:#8A8A92\"><h5>zebrahub/<s>12 obj · 10.36 GiB · 10.8%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.13);color:#8A8A92\"><span class=\"p\">zebrahub_base.h5ad</span><span class=\"n\">5.00</span><span class=\"t\" title=\"the combined atlas\">the combined atlas</span></div><div class=\"fk d1\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.13);color:#8A8A92\"><span class=\"p\">timepoints/</span><span class=\"n\">5.36</span><span class=\"t\" title=\"11 per-stage releases, 10 hpf to 10 dpf\">11 per-stage releases, 10 hpf to 10 dpf</span></div></div></div><div class=\"fkds\" style=\"--acc:#6E8CA0\"><h5>megafin-1/<s>61 obj · 5.00 GiB · 5.2%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.13);color:#E8A33F\"><span class=\"p\">characterization/</span><span class=\"n\">5.00</span><span class=\"t\" title=\"61 objects — scripts, CSVs, diff reports; byte-identical to a copy in bronze\">61 objects — scripts, CSVs, diff reports; byte-identical to a copy in bronze</span></div><div class=\"fk d2\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.13);color:#E8A33F\"><span class=\"p\">│   ├── parse_megafin1.h5ad</span><span class=\"n\">4.87</span><span class=\"t\" title=\"1 obj\">1 obj</span></div><div class=\"fk d2\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.13);color:#E8A33F\"><span class=\"p\">│   ├── fp_ours2</span><span class=\"n\">0.05</span><span class=\"t\" title=\"7 obj\">7 obj</span></div><div class=\"fk d2\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.13);color:#E8A33F\"><span class=\"p\">│   ├── fp_parse</span><span class=\"n\">0.04</span><span class=\"t\" title=\"14 obj\">14 obj</span></div><div class=\"fk d2\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.13);color:#E8A33F\"><span class=\"p\">│   ├── fp_ours</span><span class=\"n\">0.03</span><span class=\"t\" title=\"7 obj\">7 obj</span></div></div></div><div class=\"fkds\" style=\"--acc:#9C7BA0\"><h5>minifin/<s>13 obj · 4.47 GiB · 4.7%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">CHANGELOG.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"the ledger\">the ledger</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v1/</span><span class=\"n\">1.46</span><span class=\"t\" title=\"minifin.h5ad + README — 2 objects\">minifin.h5ad + README — 2 objects</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v2/</span><span class=\"n\">1.45</span><span class=\"t\" title=\"minifin.h5ad + README — 2 objects\">minifin.h5ad + README — 2 objects</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v3/</span><span class=\"n\">1.47</span><span class=\"t\" title=\"minifin.h5ad + README — 2 objects\">minifin.h5ad + README — 2 objects</span></div><div class=\"fk d1\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">(six flat keys)</span><span class=\"n\">0.09</span><span class=\"t\" title=\"6 objects — rebuild h5ads, a disposition parquet, and .provenance.json sidecars\">6 objects — rebuild h5ads, a disposition parquet, and .provenance.json sidecars</span></div></div></div>",
