...
{id:"BRONZE", key:"1", group:"① Bronze", groupMark:true, anchor:true,
 ...
 kv:[["Bucket","zsb-bronze-fortknox"],["Objects","136,246"],["Size","9.56 TiB (10,511,458,293,692 B)"],
   ["— anchor stages —","minifin · megafin-1 · megafin-2"],
   ["1_FASTQ","209 GiB · 1.67 TiB · 1.53 TiB"],
   ["2_BAM","122 GiB · 1.01 TiB · 950 GiB"],
   ["3_DGE-unfiltered","3.76 GiB · 23.2 GiB · 20.7 GiB"],
   ["4_DGE-filtered","2.42 GiB · 15.4 GiB · 15.5 GiB"],
   ["5_PARSE-insights","1.76 GiB · 10.4 GiB · 10.6 GiB"],
   ["5_RDS","0.93 GiB · 4.94 GiB · 5.03 GiB"],
   ["6_PARSE-support","12.1 GiB · 193 GiB · 190 GiB"],
   ["— tier —",""],
   ...
   ["Read on","2026-09-07 — eleventh read; all three datasets complete"]]},
...
{id:"BPUB", key:"2d", group:"② Bronze → Silver", shape:"cell", tier:"bronze", state:"live",
 ...
 kv:[["Command","uv run zsb-bronze minifin publish"],["Wrote","minifin/v1/, v2/, v3/"],["Ran","2026-08-23 · 2026-08-28 ×2"],["v1","1,562,739,920 B · parse-settings"],["v2","1,559,526,002 B · barcode-ranks"],["v3","1,583,429,276 B · ambient-profile"],["Ledger","rewritten last, all three times"],["Delete path","none"]]},
...
{id:"SILVER", key:"4", group:"④ Silver", groupMark:true, anchor:true,
 ...
 name:"Silver", bucket:"SILVER", right:"111 obj · 112.12 GiB",
 ...
 tiles:[
   /* accent = the category colour the reader's tree uses, so a tile on the map
      and its block in the panel are visibly the same kind of thing. Green is a
      published release, blue an acquired source, grey predates the repos,
      magenta is retained-but-never-published. */
   {key:"megafin/",   value:60304280896, objs:5,  accent:"#4FCB8A"},
   {key:"chemfish/",  value:38781117028, objs:20, accent:"#6FA8E8"},
   {key:"zebrahub/",  value:11127199502, objs:12, accent:"#8A8A92"},
   {key:"megafin-1/", value:5367910950,  objs:61, accent:"#B07AA1"},
   {key:"minifin/",   value:4803436795,  objs:13, accent:"#4FCB8A"},
 ],
 panel:"<style>.fkw{margin:.3rem 0 0;font-family:var(--mono,ui-monospace,monospace);font-size:clamp(9px,calc(var(--reader-w,360px)*0.0145),12px)}.fkl{display:flex;flex-direction:column;gap:.2rem;margin:.1rem 0 .55rem;font-size:clamp(9px,calc(var(--reader-w,360px)*0.014),11.5px);color:var(--fg2)}.fkl b{display:flex;align-items:center;gap:.45rem;font-weight:400}.fkl i{width:1.9em;height:.8em;border-radius:2px;flex:0 0 auto}.fkds{border:2px solid var(--acc);border-radius:5px;overflow:hidden;margin-bottom:1rem}.fkds h5{margin:0;padding:.4em .6em;font-family:var(--sans,system-ui);font-size:1.15em;font-weight:700;color:var(--acc);background:color-mix(in srgb,var(--acc) 12%,transparent);display:flex;justify-content:space-between;align-items:baseline;gap:.5em}.fkds h5 s{text-decoration:none;font-size:.62em;font-weight:600;opacity:.75}.fkg{display:flex;align-items:stretch;border-top:1px solid var(--rule,#2a2a2e)}.fkgl{flex:0 0 1.5em;display:flex;align-items:center;justify-content:center;writing-mode:vertical-rl;rotate:180deg;font-size:.62em;font-weight:700;letter-spacing:.06em;text-transform:uppercase;overflow:hidden;white-space:nowrap}.fkr{flex:1 1 auto;min-width:0}.fk{display:grid;grid-template-columns:minmax(0,1.3fr) 4.4em minmax(0,1.1fr);gap:0 .7em;padding:.16em .5em;line-height:1.5;border-left:2px solid transparent;align-items:baseline}.fk .p{white-space:pre;overflow:hidden;text-overflow:ellipsis}.fk .n{text-align:right;font-variant-numeric:tabular-nums;opacity:.85}.fk .t{font-family:var(--sans,system-ui);font-size:.88em;opacity:.55;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.fk.d1 .p{font-size:1.12em;font-weight:700}.fk.d2{opacity:.82}.fk.d2 .p{font-size:.94em}.fk.d3{opacity:.68}.fk.d3 .p{font-size:.88em}.fkh{font-size:.76em;letter-spacing:.09em;text-transform:uppercase;opacity:.45;border-bottom:1px solid var(--rule,#2a2a2e);padding:.3em .6em}</style><div class=\"fkl\"><b><i style=\"background:linear-gradient(90deg,#4FCB8A 0 50%,rgba(79,203,138,.13) 50%)\"></i>Published release — written here by zsb-bronze under the version convention</b><b><i style=\"background:linear-gradient(90deg,#6FA8E8 0 50%,rgba(111,168,232,.13) 50%)\"></i>Acquired source — taken verbatim from a public origin, custody in zsb-bronze</b><b><i style=\"background:linear-gradient(90deg,#8A8A92 0 50%,rgba(138,138,146,.13) 50%)\"></i>Predates the repos — written by neither, never versioned</b><b><i style=\"background:linear-gradient(90deg,#B07AA1 0 50%,rgba(176,122,161,.13) 50%)\"></i>Legacy — archived elsewhere or superseded; retained, never published</b></div><div class=\"fkds\" style=\"--acc:#C08552\"><h5>megafin/<s>5 obj · 56.16 GiB · 50.1%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">CHANGELOG.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"the ledger, rewritten last on every publish\">the ledger, rewritten last on every publish</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v1/</span><span class=\"n\">27.99</span><span class=\"t\" title=\"parse-settings — 1,340,518 called cells\">parse-settings — 1,340,518 called cells</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── megafin.h5ad</span><span class=\"n\">27.99</span><span class=\"t\" title=\"the release artifact\">the release artifact</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"what the policy was and what it produced\">what the policy was and what it produced</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v2/</span><span class=\"n\">28.17</span><span class=\"t\" title=\"ambient-profile — 1,409,574 called cells\">ambient-profile — 1,409,574 called cells</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── megafin.h5ad</span><span class=\"n\">28.17</span><span class=\"t\" title=\"the release artifact\">the release artifact</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"what the policy was and what it produced\">what the policy was and what it produced</span></div></div></div><div class=\"fkds\" style=\"--acc:#7FB5A8\"><h5>chemfish/<s>20 obj · 36.12 GiB · 32.2%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"which release to use, and why neither contains the other\">which release to use, and why neither contains the other</span></div><div class=\"fk d1\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">Paper/</span><span class=\"n\">0.01</span><span class=\"t\" title=\"one preprint, covering work in both releases\">one preprint, covering work in both releases</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── ChemFish_Barkan_2025.pdf</span><span class=\"n\">0.01</span><span class=\"t\" title=\"bioRxiv 2025-04-03 — 38 pages; predates the 2026-09 genetic arm\">bioRxiv 2025-04-03 — 38 pages; predates the 2026-09 genetic arm</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"what the preprint does and does not cover\">what the preprint does and does not cover</span></div><div class=\"fk d1\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">2025_03_release/</span><span class=\"n\">20.04</span><span class=\"t\" title=\"the authors’ March 2025 publication — superseded upstream, recoverable only here\">the authors’ March 2025 publication — superseded upstream, recoverable only here</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── RDS_Data/</span><span class=\"n\">20.03</span><span class=\"t\" title=\"7 objects — 6 data files + SHA256SUMS computed here, not published upstream\">7 objects — 6 data files + SHA256SUMS computed here, not published upstream</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── chemfish_cds.tar</span><span class=\"n\">19.95</span><span class=\"t\" title=\"sealed BPCells cds tarball\">sealed BPCells cds tarball</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── pectoral_fin_WT_cds.tar</span><span class=\"n\">0.07</span><span class=\"t\" title=\"sealed BPCells cds tarball\">sealed BPCells cds tarball</span></div><div class=\"fk d2\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">│   ├── Paper/</span><span class=\"n\">0.01</span><span class=\"t\" title=\"superseded by chemfish/Paper/ — awaiting delete, the instance role has no s3:DeleteObject\">superseded by chemfish/Paper/ — awaiting delete, the instance role has no s3:DeleteObject</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"provenance, what changed, and the do-not-re-fetch warning\">provenance, what changed, and the do-not-re-fetch warning</span></div><div class=\"fk d1\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">2026_09_release/</span><span class=\"n\">16.06</span><span class=\"t\" title=\"the September 2026 publication — what the six URLs serve today\">the September 2026 publication — what the six URLs serve today</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── RDS_Data/</span><span class=\"n\">16.06</span><span class=\"t\" title=\"7 objects — 6 data files + SHA256SUMS computed here, not published upstream\">7 objects — 6 data files + SHA256SUMS computed here, not published upstream</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── chemfish_cds.tar</span><span class=\"n\">15.87</span><span class=\"t\" title=\"sealed BPCells cds tarball\">sealed BPCells cds tarball</span></div><div class=\"fk d3\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   │   ├── chemfish_DEGs.RDS</span><span class=\"n\">0.12</span><span class=\"t\" title=\"author result table\">author result table</span></div><div class=\"fk d2\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"provenance, what changed, and the do-not-re-fetch warning\">provenance, what changed, and the do-not-re-fetch warning</span></div></div></div><div class=\"fkds\" style=\"--acc:#8A8A92\"><h5>zebrahub/<s>12 obj · 10.36 GiB · 9.2%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.13);color:#8A8A92\"><span class=\"p\">zebrahub_base.h5ad</span><span class=\"n\">5.00</span><span class=\"t\" title=\"the combined atlas\">the combined atlas</span></div><div class=\"fk d1\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.13);color:#8A8A92\"><span class=\"p\">timepoints/</span><span class=\"n\">5.36</span><span class=\"t\" title=\"11 per-stage releases, 10 hpf to 10 dpf\">11 per-stage releases, 10 hpf to 10 dpf</span></div></div></div><div class=\"fkds\" style=\"--acc:#6E8CA0\"><h5>megafin-1/<s>61 obj · 5.00 GiB · 4.5%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">characterization/</span><span class=\"n\">5.00</span><span class=\"t\" title=\"61 objects — already archived to bronze 2026-08-29, byte-identical, zero size disagreements\">61 objects — already archived to bronze 2026-08-29, byte-identical, zero size disagreements</span></div><div class=\"fk d2\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">│   ├── parse_megafin1.h5ad</span><span class=\"n\">4.87</span><span class=\"t\" title=\"1 obj\">1 obj</span></div><div class=\"fk d2\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">│   ├── fp_ours2</span><span class=\"n\">0.05</span><span class=\"t\" title=\"7 obj\">7 obj</span></div><div class=\"fk d2\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">│   ├── fp_parse</span><span class=\"n\">0.04</span><span class=\"t\" title=\"14 obj\">14 obj</span></div><div class=\"fk d2\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">│   ├── fp_ours</span><span class=\"n\">0.03</span><span class=\"t\" title=\"7 obj\">7 obj</span></div></div></div><div class=\"fkds\" style=\"--acc:#9C7BA0\"><h5>minifin/<s>13 obj · 4.47 GiB · 4.0%</s></h5><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">CHANGELOG.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"the ledger\">the ledger</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v1/</span><span class=\"n\">1.46</span><span class=\"t\" title=\"parse-settings — 94,864 called cells\">parse-settings — 94,864 called cells</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── minifin.h5ad</span><span class=\"n\">1.46</span><span class=\"t\" title=\"the release artifact\">the release artifact</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"what the policy was and what it produced\">what the policy was and what it produced</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v2/</span><span class=\"n\">1.45</span><span class=\"t\" title=\"barcode-ranks — 94,089 called cells\">barcode-ranks — 94,089 called cells</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── minifin.h5ad</span><span class=\"n\">1.45</span><span class=\"t\" title=\"the release artifact\">the release artifact</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"what the policy was and what it produced\">what the policy was and what it produced</span></div><div class=\"fk d1\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">v3/</span><span class=\"n\">1.47</span><span class=\"t\" title=\"ambient-profile — 106,022 called cells\">ambient-profile — 106,022 called cells</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── minifin.h5ad</span><span class=\"n\">1.47</span><span class=\"t\" title=\"the release artifact\">the release artifact</span></div><div class=\"fk d2\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">│   ├── README.md</span><span class=\"n\">0.00</span><span class=\"t\" title=\"what the policy was and what it produced\">what the policy was and what it produced</span></div><div class=\"fk d1\" style=\"border-left-color:#B07AA1;background:rgba(176,122,161,.13);color:#B07AA1\"><span class=\"p\">(six flat keys)</span><span class=\"n\">0.09</span><span class=\"t\" title=\"6 objects — rebuild h5ads, a disposition parquet, and .provenance.json sidecars\">6 objects — rebuild h5ads, a disposition parquet, and .provenance.json sidecars</span></div></div></div>",
 brief:"Rudimentary h5ad: counts plus the mandatory corrections, and nothing anyone could reasonably disagree with. The hinge of the architecture — the last tier where the data is still just what was measured. 111 objects, 112.12 GiB, <mark>1.14% the size of bronze</mark>. <mark>ChemFish is the first tile here that exists in two versions we did not make</mark>: its public origin overwrote itself, so the warehouse holds both publications side by side.",
 ...
 built:"111 objects, 120,383,945,171 bytes, read 2026-09-08 — nine objects and 16.06 GiB more than the read earlier the same day, all of it <mark>chemfish/2026_09_release/</mark>. It is 1.14% the size of bronze. Every ChemFish file was verified against a SHA-256 manifest before upload, both multi-gigabyte tarballs read in full. <mark>Those digests are ours, computed at acquisition</mark> — the origin publishes no checksum file at all, so a passing check proves the copy is unchanged since we took it, not that it is what the authors intended.",
 ...
 kv:[["Bucket","zsb-silver-warehouse"],["Objects","111"],["Size","112.12 GiB (120,383,945,171 B)"],["vs bronze","1.14%"],["Versioned releases","5 — minifin/v1–v3, chemfish/2025_03 + 2026_09"],["New this read","chemfish/2026_09_release/ — 8 objects, 16.06 GiB"],["Written by zsb-bronze","4.38 GiB across minifin/v1–v3"],["Acquired verbatim","36.11 GiB — ChemFish ×2 releases, custody in zsb-bronze"],["Upstream mutability","the ChemFish origin overwrote 5 of 6 artifacts in place on 2026-09-03"],["Read on","2026-09-08"]]},
...
{id:"GOLD", key:"6", group:"⑥ Gold", groupMark:true, anchor:true,
 ...
 tiles:[
   ...
   {key:"minifin/",  value:8304526290,  objs:7},
   {key:"zebrahub/", value:5481247280,  objs:2},
 ],
 brief:"The terminal tier: analysis-ready, immutable, versioned, and what every model downstream actually trains on. <mark>This tier was drawn empty for six reads because the role could not see it. It is not empty.</mark> Fourteen objects, 93.85 GiB, and the key convention that was settled in prose on 2026-08-23 is now realised in the bucket: <mark>&lt;dataset&gt;/&lt;recipe&gt;/&lt;version&gt;/</mark>. Two datasets, two recipes each, published side by side the way silver publishes its three. Gold is now larger than silver.",
 ...
 built:"14 objects, 100,769,607,200 bytes, read 2026-09-07 — the first read with ListBucket on this bucket. <mark>megafin/</mark> is 86.4 GiB of it across two recipes, <mark>minifin/</mark> 7.7 GiB across three releases, and <mark>zebrahub/</mark> 5.1 GiB that predates the repos exactly as it does in silver. Every release carries a README beside its h5ad and a CHANGELOG above it.",
 cond:"<mark>The unknown resolved, and it resolved the other way.</mark> For six reads this panel said the tier was unreadable and therefore undrawn — <em>unknown, not known to be empty</em> — and the distinction was the point, because the two call for different next actions. The role was widened on 2026-09-07 and the answer is that gold has been in use since 2026-07-27. <mark>The key convention is realised, not merely settled.</mark> Every artifact sits at &lt;dataset&gt;/&lt;recipe&gt;/&lt;version&gt;/ — minifin/parse/v1/, minifin/zsb/v1/, minifin/zsb/v2/, megafin/parse/v1/, megafin/zsb/v1/ — which is the convention zsb-gold wrote down on 2026-08-23 and this map carried as an open gate for two passes afterwards. <mark>Two recipes are published side by side for both datasets</mark>, the same argument silver makes with v1/v2/v3: the vendor's call and ours, neither superseding the other. <mark>Gold is larger than silver</mark> — 93.85 GiB against 76.00 — because the zsb recipe of MegaFin alone is 51.2 GiB, and the medallion shape does not promise monotonic shrinkage past the tier where opinion starts. <mark>zebrahub/</mark> is here too, 5.1 GiB from 2026-07-27, predating the repos exactly as its twin does in silver and written by neither. The lesson this tier taught for six reads still stands and is worth keeping: a refusal is not a fact about the data, and the map was right to say so rather than draw an empty box.",
...
/* Gold was unverifiable for six reads — ListBucket AccessDenied, HeadBucket 403.
   The role was widened 2026-09-07 and the bucket read cleanly. Nothing is unverified now. */
/* The read date lives here, not in ds-view.js. The fifth pass found it hardcoded
   twice in the renderer, against the ownership table, and said to move it the next
   time somebody touched the reader. Moved 2026-09-07. */
const READ_DATE = "2026-09-07";
...
const OVERVIEW = {
  ...
  sub: "three tiers · four hops, all four run · two datasets end to end",
  ...
  state: `<mark>All four hops have run.</mark> Gold was unreadable for six reads and is not empty — 14 objects, 93.85 GiB, at the key convention this map carried as an open gate. Two datasets now go end to end, two recipes each, published side by side. Every gate that raised is implemented. Gold is larger than silver, which is what happens past the tier where opinion starts.`,
