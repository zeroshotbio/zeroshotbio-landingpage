...
{id:"SILVER", key:"4", group:"④ Silver", groupMark:true, anchor:true,
 ...
 name:"Silver", bucket:"SILVER", right:"109 obj · 112.11 GiB",
 ...
 tiles:[
   ...
   {key:"chemfish/",  value:38769734213, objs:18, accent:"#6FA8E8"},
 ...
 built:"109 objects, 120,372,562,356 bytes, read 2026-09-08 — nine objects and 16.06 GiB more than the read earlier the same day, all of it <mark>chemfish/2026_09_release/</mark>. It is 1.14% the size of bronze. Every ChemFish file was verified against a SHA-256 manifest before upload, both multi-gigabyte tarballs read in full. <mark>Those digests are ours, computed at acquisition</mark> — the origin publishes no checksum file at all, so a passing check proves the copy is unchanged since we took it, not that it is what the authors intended.",
