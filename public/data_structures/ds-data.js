/* ============================================================
   ...
   and from the four repositories at these commits:
     ...
     zsb-bronze     d595a82   main              156 commits   5,205 LOC
     zsb-silver     560d34a   main               38 commits   2,552 LOC
...
{id:"BRONZE", key:"1", group:"① Bronze", groupMark:true, anchor:true,
 ...
 name:"Bronze", bucket:"BRONZE", right:"136,007 obj · 8.22 TiB",
 x:COL_BUCKET, y:11, w:24, h:22,
 sub:"s3://zsb-bronze-fortknox",
 tiles:[
   {key:"megafin-1/", value:5058148910735, objs:60717, legacy:1868397757280},
   {key:"megafin-2/", value:3216016766121, objs:60487, legacy:1698635254871},
   {key:"minifin/", value:759208795497, objs:14786, legacy:378619764302},
   {key:"reference/", value:1563032418, objs:15, legacy:0},
 ],
 panel:"<style>.fkw{margin:.3rem 0 1rem;font-family:var(--mono,ui-monospace,monospace);font-size:clamp(9px,calc(var(--reader-w,360px)*0.030),15px)}.fkl{display:flex;flex-direction:column;gap:.2rem;margin:.1rem 0 .6rem;font-size:clamp(9px,calc(var(--reader-w,360px)*0.029),14px);color:var(--fg2)}.fkl b{display:flex;align-items:center;gap:.45rem;font-weight:400}.fkl i{width:1.9em;height:.8em;border-radius:2px;flex:0 0 auto}.fkg{display:flex;align-items:stretch;border-top:1px solid var(--rule,#2a2a2e)}.fkgl{flex:0 0 1.6em;display:flex;align-items:center;justify-content:center;writing-mode:vertical-rl;rotate:180deg;font-size:.82em;font-weight:700;letter-spacing:.12em;text-transform:uppercase;overflow:hidden}.fkr{flex:1 1 auto;min-width:0}.fk{display:grid;grid-template-columns:minmax(0,1.35fr) 4.4em minmax(0,1.15fr);gap:0 .7em;padding:.18em .5em;line-height:1.5;border-left:2px solid transparent;align-items:baseline}.fk .p{white-space:pre;overflow:hidden;text-overflow:ellipsis}.fk .n{text-align:right;font-variant-numeric:tabular-nums;opacity:.9}.fk .t{font-family:var(--sans,system-ui);font-size:.9em;opacity:.62;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.fkh{font-size:.78em;letter-spacing:.09em;text-transform:uppercase;opacity:.5;border-bottom:1px solid var(--rule,#2a2a2e);padding-bottom:.25em}</style><h4>minifin/</h4><div class=\"fkl\"><b><i style=\"background:linear-gradient(90deg,#6FA8E8 0 50%,rgba(111,168,232,.13) 50%)\"></i>Canonical \u2014 separate delivery</b><b><i style=\"background:linear-gradient(90deg,#4FCB8A 0 50%,rgba(79,203,138,.13) 50%)\"></i>New \u2014 fresh \u201cAll Files\u201d download</b><b><i style=\"background:linear-gradient(90deg,#E8A33F 0 50%,rgba(232,163,63,.15) 50%)\"></i>Awaiting your next upload</b><b><i style=\"background:linear-gradient(90deg,#B884E8 0 50%,rgba(184,132,232,.13) 50%)\"></i>Zeroshot-authored, not Parse</b><b><i style=\"background:linear-gradient(90deg,#8A8A92 0 50%,rgba(138,138,146,.10) 50%)\"></i>Legacy \u2014 moves to zsb-bronze-archive</b></div><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk\" style=\"font-weight:600\"><span class=\"p\">minifin/</span><span class=\"n\">707.07</span><span class=\"t\">14,786 obj</span></div><div class=\"fkg\"><div class=\"fkgl\" style=\"color:#4FCB8A;border-right:2px solid #4FCB8A\">Aspirational</div><div class=\"fkr\"><div class=\"fk\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">\u251c\u2500\u2500 1_FASTQ/</span><span class=\"n\">209.46</span><span class=\"t\" title=\"FASTQ delivery, not All Files\">FASTQ delivery, not All Files</span></div><div class=\"fk\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">\u2502   \u251c\u2500\u2500 raw-read-files/</span><span class=\"n\">209.46</span><span class=\"t\" title=\"8 sublibs \u00d7 R1/R2\">8 sublibs \u00d7 R1/R2</span></div><div class=\"fk\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">\u2502   \u2514\u2500\u2500 sequencing-metadata/</span><span class=\"n\">2 KB</span><span class=\"t\" title=\"md5 checksums\">md5 checksums</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 2_BAM/</span><span class=\"n\">121.57</span><span class=\"t\" title=\"All Files only\">All Files only</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2514\u2500\u2500 alignment-bams/</span><span class=\"n\">121.57</span><span class=\"t\" title=\"one per sublibrary, incl. 3b\">one per sublibrary, incl. 3b</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 3_DGE-unfiltered/</span><span class=\"n\">3.76</span><span class=\"t\" title=\"396 dirs \u00d7 3\">396 dirs \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 combined/</span><span class=\"n\">1.84</span><span class=\"t\" title=\"44 samples \u00d7 3\">44 samples \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 per-sublibrary/</span><span class=\"n\">1.91</span><span class=\"t\" title=\"8 \u00d7 44 \u00d7 3\">8 \u00d7 44 \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 4_DGE-filtered/</span><span class=\"n\">2.42</span><span class=\"t\" title=\"396 dirs \u00d7 3\">396 dirs \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 combined/</span><span class=\"n\">1.18</span><span class=\"t\" title=\"44 samples \u00d7 3\">44 samples \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 per-sublibrary/</span><span class=\"n\">1.24</span><span class=\"t\" title=\"8 \u00d7 44 \u00d7 3\">8 \u00d7 44 \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.15);color:#E8A33F\"><span class=\"p\">\u251c\u2500\u2500 5_RDS/</span><span class=\"n\">1.87</span><span class=\"t\" title=\"awaiting upload\">awaiting upload</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 6_PARSE-support/</span><span class=\"n\">12.09</span><span class=\"t\" title=\"everything not a BAM or DGE matrix\">everything not a BAM or DGE matrix</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 combined/</span><span class=\"n\">0.91</span><span class=\"t\" title=\"from output_combined/\">from output_combined/</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u251c\u2500\u2500 &lt;sample&gt;/report/</span><span class=\"n\">0.17</span><span class=\"t\" title=\"QC + metrics CSVs\">QC + metrics CSVs</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u251c\u2500\u2500 &lt;sample&gt;/figures/</span><span class=\"n\">0.05</span><span class=\"t\" title=\"fig_cell_by_rnd*.png\">fig_cell_by_rnd*.png</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u251c\u2500\u2500 *_analysis_summary.html</span><span class=\"n\">0.69</span><span class=\"t\" title=\"+ all_summaries.zip\">+ all_summaries.zip</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u2514\u2500\u2500 process/</span><span class=\"n\">2 MB</span><span class=\"t\" title=\"run_proc_def.json, all_genes\">run_proc_def.json, all_genes</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2514\u2500\u2500 per-sublibrary/</span><span class=\"n\">11.18</span><span class=\"t\" title=\"8 sublibrary trees\">8 sublibrary trees</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u251c\u2500\u2500 sublib_N/&lt;sample&gt;/report/</span><span class=\"n\">0.40</span><span class=\"t\" title=\"44 samples \u00d7 17 files \u00d7 8\">44 samples \u00d7 17 files \u00d7 8</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u251c\u2500\u2500 sublib_N/&lt;sample&gt;/figures/</span><span class=\"n\">0.27</span><span class=\"t\" title=\"PNGs per sample\">PNGs per sample</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u251c\u2500\u2500 sublib_N/ root HTML + logs</span><span class=\"n\">1.41</span><span class=\"t\" title=\"summaries, split-pipe logs\">summaries, split-pipe logs</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u2514\u2500\u2500 sublib_N/process/</span><span class=\"n\">9.10</span><span class=\"t\" title=\"tscp_assignment.csv.gz dominates\">tscp_assignment.csv.gz dominates</span></div><div class=\"fk\" style=\"border-left-color:#B884E8;background:rgba(184,132,232,.13);color:#B884E8\"><span class=\"p\">\u251c\u2500\u2500 dataset-reference/</span><span class=\"n\">3.29</span><span class=\"t\" title=\"our own material\">our own material</span></div><div class=\"fk\" style=\"border-left-color:#B884E8;background:rgba(184,132,232,.13);color:#B884E8\"><span class=\"p\">\u2502   \u251c\u2500\u2500 annotation/</span><span class=\"n\">3.07</span><span class=\"t\" title=\"zscape harmonized refs\">zscape harmonized refs</span></div><div class=\"fk\" style=\"border-left-color:#B884E8;background:rgba(184,132,232,.13);color:#B884E8\"><span class=\"p\">\u2502   \u251c\u2500\u2500 paralogs.tsv + PARALOGS_NOTE.md</span><span class=\"n\">0.22</span><span class=\"t\" title=\"MiniFin-only\">MiniFin-only</span></div><div class=\"fk\" style=\"border-left-color:#B884E8;background:rgba(184,132,232,.13);color:#B884E8\"><span class=\"p\">\u2502   \u2514\u2500\u2500 barcodes/BARCODES_NOTE.md</span><span class=\"n\">7 KB</span><span class=\"t\" title=\"differs per dataset\">differs per dataset</span></div></div></div><div class=\"fkg\"><div class=\"fkgl\" style=\"color:#8A8A92;border-right:2px solid #8A8A92\">Legacy</div><div class=\"fkr\"><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 parse-output/</span><span class=\"n\">138.40</span><span class=\"t\" title=\"the OLD delivery, a354c053\">the OLD delivery, a354c053</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 split-pipe-raw/</span><span class=\"n\">135.02</span><span class=\"t\" title=\"old 9 ZIPs \u2014 1 combine + 8 sublib\">old 9 ZIPs \u2014 1 combine + 8 sublib</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 dge-unfiltered/</span><span class=\"n\">0.92</span><span class=\"t\" title=\"= new combined/all-sample, older\">= new combined/all-sample, older</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 dge-filtered/</span><span class=\"n\">0.59</span><span class=\"t\" title=\"what MANIFEST still pins\">what MANIFEST still pins</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 *.rds \u00d72</span><span class=\"n\">1.87</span><span class=\"t\" title=\"source of 5_RDS/\">source of 5_RDS/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 qc/per-sublibrary/</span><span class=\"n\">57 KB</span><span class=\"t\" title=\"the sublibN \u2260 __sN trap\">the sublibN \u2260 __sN trap</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u2514\u2500\u2500 settings \u00b7 cutoffs \u00b7 summaries</span><span class=\"n\">36 KB</span><span class=\"t\" title=\"\"></span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 raw-fastq/</span><span class=\"n\">209.46</span><span class=\"t\" title=\"source for 1_FASTQ/\">source for 1_FASTQ/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 reference/</span><span class=\"n\">4.74</span><span class=\"t\" title=\"dupe of shared + dataset-reference\">dupe of shared + dataset-reference</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 annotation/</span><span class=\"n\">3.07</span><span class=\"t\" title=\"now in dataset-reference/\">now in dataset-reference/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 lawson_v4.3.2/ \u00b7 ensembl_99/</span><span class=\"n\">1.46</span><span class=\"t\" title=\"now in shared reference/\">now in shared reference/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u2514\u2500\u2500 barcodes/ \u00b7 paralogs \u00b7 notes</span><span class=\"n\">0.22</span><span class=\"t\" title=\"\"></span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 results/</span><span class=\"n\">0.01</span><span class=\"t\" title=\"Zeroshot minifin_rebuild, not Parse\">Zeroshot minifin_rebuild, not Parse</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2514\u2500\u2500 REFERENCE_NOTE.md \u00b7 reference-note.md</span><span class=\"n\">8 KB</span><span class=\"t\" title=\"differ only by case\">differ only by case</span></div></div></div></div><h4>megafin-1/</h4><div class=\"fkl\"><b><i style=\"background:linear-gradient(90deg,#6FA8E8 0 50%,rgba(111,168,232,.13) 50%)\"></i>Canonical \u2014 separate delivery</b><b><i style=\"background:linear-gradient(90deg,#4FCB8A 0 50%,rgba(79,203,138,.13) 50%)\"></i>New \u2014 fresh \u201cAll Files\u201d download</b><b><i style=\"background:linear-gradient(90deg,#E8A33F 0 50%,rgba(232,163,63,.15) 50%)\"></i>Awaiting your next upload</b><b><i style=\"background:linear-gradient(90deg,#B884E8 0 50%,rgba(184,132,232,.13) 50%)\"></i>Zeroshot-authored, not Parse</b><b><i style=\"background:linear-gradient(90deg,#8A8A92 0 50%,rgba(138,138,146,.10) 50%)\"></i>Legacy \u2014 moves to zsb-bronze-archive</b></div><div class=\"fkw\"><div class=\"fk fkh\"><span>path</span><span class=\"n\">GiB</span><span>note</span></div><div class=\"fk\" style=\"font-weight:600\"><span class=\"p\">megafin-1/</span><span class=\"n\">4,710.77</span><span class=\"t\">60,717 obj</span></div><div class=\"fkg\"><div class=\"fkgl\" style=\"color:#4FCB8A;border-right:2px solid #4FCB8A\">Aspirational</div><div class=\"fkr\"><div class=\"fk\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">\u251c\u2500\u2500 1_FASTQ/</span><span class=\"n\">1,708.10</span><span class=\"t\" title=\"FASTQ delivery, not All Files\">FASTQ delivery, not All Files</span></div><div class=\"fk\" style=\"border-left-color:#6FA8E8;background:rgba(111,168,232,.13);color:#6FA8E8\"><span class=\"p\">\u2502   \u2514\u2500\u2500 raw-read-files/</span><span class=\"n\">1,708.10</span><span class=\"t\" title=\"16 sublibs \u00d7 R1/R2 \u00d7 8 lanes\">16 sublibs \u00d7 R1/R2 \u00d7 8 lanes</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 2_BAM/</span><span class=\"n\">1,031.29</span><span class=\"t\" title=\"All Files only\">All Files only</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 alignment-bams/</span><span class=\"n\">968.09</span><span class=\"t\" title=\"one per sublibrary, ~60 GiB each\">one per sublibrary, ~60 GiB each</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2514\u2500\u2500 intermediate-bams/</span><span class=\"n\">63.20</span><span class=\"t\" title=\"sublib_13 (31) \u00b7 sublib_15 (8)\">sublib_13 (31) \u00b7 sublib_15 (8)</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 3_DGE-unfiltered/</span><span class=\"n\">23.20</span><span class=\"t\" title=\"1,649 dirs \u00d7 3\">1,649 dirs \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 combined/</span><span class=\"n\">11.46</span><span class=\"t\" title=\"97 samples \u00d7 3\">97 samples \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2514\u2500\u2500 per-sublibrary/</span><span class=\"n\">11.73</span><span class=\"t\" title=\"16 \u00d7 97 \u00d7 3\">16 \u00d7 97 \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 4_DGE-filtered/</span><span class=\"n\">15.39</span><span class=\"t\" title=\"1,649 dirs \u00d7 3\">1,649 dirs \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 combined/</span><span class=\"n\">7.57</span><span class=\"t\" title=\"97 samples \u00d7 3\">97 samples \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2514\u2500\u2500 per-sublibrary/</span><span class=\"n\">7.82</span><span class=\"t\" title=\"16 \u00d7 97 \u00d7 3\">16 \u00d7 97 \u00d7 3</span></div><div class=\"fk\" style=\"border-left-color:#E8A33F;background:rgba(232,163,63,.15);color:#E8A33F\"><span class=\"p\">\u251c\u2500\u2500 5_RDS/</span><span class=\"n\">\u2014</span><span class=\"t\" title=\"awaiting upload\">awaiting upload</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u251c\u2500\u2500 6_PARSE-support/</span><span class=\"n\">192.71</span><span class=\"t\" title=\"everything not a BAM or DGE matrix\">everything not a BAM or DGE matrix</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u251c\u2500\u2500 combined/</span><span class=\"n\">4.48</span><span class=\"t\" title=\"from output_combined/\">from output_combined/</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u251c\u2500\u2500 &lt;sample&gt;/report/</span><span class=\"n\">0.65</span><span class=\"t\" title=\"QC + metrics CSVs\">QC + metrics CSVs</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u251c\u2500\u2500 &lt;sample&gt;/figures/</span><span class=\"n\">0.13</span><span class=\"t\" title=\"fig_cell_by_rnd*.png\">fig_cell_by_rnd*.png</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u251c\u2500\u2500 *_analysis_summary.html</span><span class=\"n\">3.70</span><span class=\"t\" title=\"+ all_summaries.zip\">+ all_summaries.zip</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2502   \u2514\u2500\u2500 process/</span><span class=\"n\">0.01</span><span class=\"t\" title=\"run_proc_def.json, all_genes\">run_proc_def.json, all_genes</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502   \u2514\u2500\u2500 per-sublibrary/</span><span class=\"n\">188.22</span><span class=\"t\" title=\"16 sublibrary trees\">16 sublibrary trees</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u251c\u2500\u2500 sublib_N/&lt;sample&gt;/report/</span><span class=\"n\">1.73</span><span class=\"t\" title=\"97 samples \u00d7 17 \u00d7 16\">97 samples \u00d7 17 \u00d7 16</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u251c\u2500\u2500 sublib_N/&lt;sample&gt;/figures/</span><span class=\"n\">1.13</span><span class=\"t\" title=\"PNGs per sample\">PNGs per sample</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u251c\u2500\u2500 sublib_N/ root HTML + logs</span><span class=\"n\">6.19</span><span class=\"t\" title=\"summaries, split-pipe logs\">summaries, split-pipe logs</span></div><div class=\"fk\" style=\"border-left-color:#4FCB8A;background:rgba(79,203,138,.13);color:#4FCB8A\"><span class=\"p\">\u2502       \u2514\u2500\u2500 sublib_N/process/</span><span class=\"n\">179.17</span><span class=\"t\" title=\"tscp_assignment.csv.gz dominates\">tscp_assignment.csv.gz dominates</span></div><div class=\"fk\" style=\"border-left-color:#B884E8;background:rgba(184,132,232,.13);color:#B884E8\"><span class=\"p\">\u2514\u2500\u2500 dataset-reference/</span><span class=\"n\">8 KB</span><span class=\"t\" title=\"our own material\">our own material</span></div><div class=\"fk\" style=\"border-left-color:#B884E8;background:rgba(184,132,232,.13);color:#B884E8\"><span class=\"p\">    \u2514\u2500\u2500 barcodes/BARCODES_NOTE.md</span><span class=\"n\">8 KB</span><span class=\"t\" title=\"differs per dataset\">differs per dataset</span></div></div></div><div class=\"fkg\"><div class=\"fkgl\" style=\"color:#8A8A92;border-right:2px solid #8A8A92\">Legacy</div><div class=\"fkr\"><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 raw-fastq/</span><span class=\"n\">1,708.10</span><span class=\"t\" title=\"source for 1_FASTQ/\">source for 1_FASTQ/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 parse-output/</span><span class=\"n\">25.53</span><span class=\"t\" title=\"both runs, untouched\">both runs, untouched</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 original-run/</span><span class=\"n\">5.48</span><span class=\"t\" title=\"processed-matrix.rds + settings.txt\">processed-matrix.rds + settings.txt</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u2502   \u2514\u2500\u2500 settings.txt</span><span class=\"n\">47,859 B</span><span class=\"t\" title=\"\u2605 differs from rerun\">\u2605 differs from rerun</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u2514\u2500\u2500 rerun/</span><span class=\"n\">20.05</span><span class=\"t\" title=\"likely superseded by ca21e8e1\">likely superseded by ca21e8e1</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502       \u251c\u2500\u2500 settings.txt</span><span class=\"n\">47,922 B</span><span class=\"t\" title=\"\u2605 differs from original-run\">\u2605 differs from original-run</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502       \u251c\u2500\u2500 dge-unfiltered.zip</span><span class=\"n\">11.46</span><span class=\"t\" title=\"never extracted\">never extracted</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502       \u2514\u2500\u2500 rds \u00b7 summaries \u00b7 reports \u00b7 logs</span><span class=\"n\">8.59</span><span class=\"t\" title=\"\"></span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u251c\u2500\u2500 reference/</span><span class=\"n\">1.46</span><span class=\"t\" title=\"duplicate of shared reference/\">duplicate of shared reference/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u251c\u2500\u2500 lawson_v4.3.2/ \u00b7 ensembl_99/</span><span class=\"n\">1.46</span><span class=\"t\" title=\"now in shared reference/\">now in shared reference/</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2502   \u2514\u2500\u2500 barcodes/ + manifest</span><span class=\"n\">33 KB</span><span class=\"t\" title=\"BARCODES_NOTE.md is per-dataset\">BARCODES_NOTE.md is per-dataset</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">\u2514\u2500\u2500 archive/2026-08-mega1-characterization/</span><span class=\"n\">5.00</span><span class=\"t\" title=\"Zeroshot, not Parse\">Zeroshot, not Parse</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">    \u251c\u2500\u2500 fp_parse/ \u00b7 fp_ours/ \u00b7 fp_ours2/</span><span class=\"n\">0.12</span><span class=\"t\" title=\"false-positive comparisons\">false-positive comparisons</span></div><div class=\"fk\" style=\"border-left-color:#8A8A92;background:rgba(138,138,146,.10);color:#8A8A92\"><span class=\"p\">    \u2514\u2500\u2500 composition \u00b7 depth \u00b7 diffs \u00b7 em_gate</span><span class=\"n\">4 MB</span><span class=\"t\" title=\"+ 17 scripts and notes at root\">+ 17 scripts and notes at root</span></div></div></div></div><p class=\"note\">megafin-2 gets its own tree once extraction finishes. Read live 2026-09-01.</p>",
 brief:"The sealed raw tier, and the only one a person may write to. Everything below it is derivable; this is not. One tile per top-level folder, at true area. <mark>Each tile is split: the bronze share is the six-stage layout the restructure built, the grey band is what still sits in the pre-restructure folders</mark> — <code>raw-fastq/</code>, <code>parse-output/</code>, <code>reference/</code>, <code>results/</code>, <code>archive/</code>. That grey <em>is</em> the duplication, drawn inside the box it belongs to: nothing can be removed until the delete invariant is amended, so all three datasets hold their FASTQs twice. The shared <code>reference/</code> tile is entirely bronze — it was built by deduplication and has no legacy half.",
...
{id:"BREPO", key:"2", group:"② Bronze → Silver", groupMark:true, anchor:true,
 ...
 name:"zsb-bronze", repo:"zsb-bronze", right:"156 commits · 5,205 LOC",
 ...
 built:"One dataset module, <mark>minifin/</mark>, implemented end to end: 2,792 lines under src, eleven test files, and six commands. The entry point changed shape — it is <mark>zsb-bronze</mark> now, one command per repo, with each dataset a subcommand group beneath it: <mark>zsb-bronze minifin fetch</mark>, <mark>process convert</mark>, <mark>process build</mark>, <mark>process all</mark>, <mark>publish</mark>, and <mark>pins</mark>. Silver and gold adopted the same shape, so the three repos now read the same way from the command line. 156 commits since 2026-07-22 — Darien 100, Steve 52 across two identities, Creighton 2, one from CI and one from Claude.",
 cond:"<mark>Every failing this map recorded in this repo is still retired, and it has acquired a new one.</mark> CI runs make verify on every push and PR, AGENTS.md points at main, the contract divergence closed at v0.8.0, and publish has now run three times. But the dataset README says <mark>barcode-ranks is 'deliberately unpublished'</mark> and its version table stops at v2 — while <mark>minifin/v3/</mark> has been in the warehouse since the 28th, published under exactly that policy, recorded in the CHANGELOG committed alongside it. Two documents in one commit, disagreeing about what is in a bucket. Open PR <mark>#49</mark> is the fix, and its title names the distinction the README was reaching for: publication is not promotion. v3 exists and is not recommended, and those are different sentences.",
...
{id:"SREPO", key:"5", group:"⑤ Silver → Gold", groupMark:true, anchor:true,
 ...
 name:"zsb-silver", repo:"zsb-silver", right:"38 commits · 2,552 LOC",
...
{id:"SPROC", key:"5b", group:"⑤ Silver → Gold", shape:"cell", tier:"silver", state:"stub",
 name:"process (silver→gold)", cellName:"process", note:"parts ported · nothing runs them",
 x:COL_REPO, y:45.9, w:19, h:3.4,
 sub:"process/ · 771 LOC of real filters · build_gold() still raises",
 thread:true,
 brief:"The heaviest step in any tier, and <mark>it stopped being a docstring</mark>. Trailmaker's QC steps 3 and 4 are ported and asserted against values produced by running the same rule in R; the doublet scorer calls real scDblFinder behind a swappable seam; a recipe names every dial. <mark>And build_gold still raises</mark>, because nothing wires them together yet. Drawn dashed, which is the honest mark: on this map a dashed plate means the function raises, and it does. The gate above it is unchanged and the work below it is no longer waiting for the gate.",
 does:"The heaviest step in any tier. QC and doublet filtering with fixed seeds, normalization and log1p, HVGs, batch-aware embeddings, clustering, and cell-type annotation — everything the silver tier deferred because two competent scientists would pick different values.",
 built:"<mark>771 lines of it exist and none of it runs from a command.</mark> <mark>mito.py</mark> is step 3, the 3-MAD mitochondrial cut; <mark>spline.py</mark> is step 4, the genes-versus-transcripts fit; <mark>doublets.py</mark> and <mark>scdblfinder.py</mark> are step 5, calling real Bioconductor scDblFinder through a seam that can be swapped for a fake in tests; <mark>grouping.py</mark> and <mark>metrics.py</mark> are the per-sample machinery underneath. <mark>recipe.py</mark> declares the dials — MAD multipliers, spline degree, expected doublet rate, HVG count, PCA components — and splits them explicitly into method defaults that carry to the next dataset and facts that are about this one, which is the division that stops a MiniFin constant being mistaken for a method. <mark>build_gold</mark> imports none of it yet and raises.",
...
{id:"GREPO", key:"7", group:"⑦ Gold — the reader", groupMark:true, anchor:true,
 ...
 kv:[["Repo","zeroshotbio/zsb-gold"],["HEAD","513ca22 (main)"],["Commits","30 — unchanged in six days"],["Source","93 LOC"],["Tests","1 file — the docstring checker"],["Depends on","zsb-medallion @ v0.8.0"],["Write path","none, by design"],["Key convention","settled — and never pinned, by design"],["Open PRs","1 — #16 chore"],["Notebooks","1 README, 0 notebooks"]]},
...
const SNIPPETS = {
  ...
  BPUB: () => ({
    ...
    body: [
      ...
      "#",
      "# the repo README calls this policy",
      "# \"deliberately unpublished\"."
    ].join("\n"),
    note: "This map once ran this command against a key that was not there. It now runs it against a key the writing repo's own README says was never published — see PR #49."
  }),
  SGAP: () => ({
