  ...
  return (
    <>
      <h1 className="roboto-slab-medium text-2xl text-gray-dark mb-8">
        Leukemia Case Studies: How tsGPT Could Change the Story
      </h1>
      ...
      <div className="w-full mb-12">
        <figure className="text-left">
          ...
          <figcaption className="roboto-slab-light text-xsm text-gray-dark mt-4">
            An overview of the underlying causes of leukemia. 
          </figcaption>
        </figure>
      </div>
          ...
          Mylotarg was developed to target CD33-positive acute myeloid leukemia (AML) cells. Although initially promising, the drug encountered significant setbacks due to severe off-target toxicities, notably hepatic veno-occlusive disease (VOD). These toxicities occurred because CD33 expression was not limited to leukemia cells, leading to inadvertent damage to normal tissues. A tsGPT model could have significantly improved the outcome by predicting the harmful gene expression responses resulting from CD33 engagement in healthy cells, enabling researchers to select safer target epitopes, optimize payload-linker designs, or suggest adjunctive treatments to reduce these toxic effects. Thus, tsGPT’s main value here lies in predicting off-target gene-regulatory cascades that manifest as clinical toxicities, allowing developers to proactively avoid such harmful outcomes.
            ...
            <div className="w-full mb-12">
              <figure className="text-left">
                ...
                />
                <figcaption className="roboto-slab-light text-xsm text-gray-dark mt-4">
                  An approximate representation of the major effects and gene expression pathway influences of Mylotarg.
                </figcaption>
              </figure>
            </div>
      ...
      <section>
        ...
        <p className="roboto-slab-light mb-6 leading-relaxed">
          Notch signaling plays a crucial role in a subset of acute lymphoblastic leukemias (ALL). Clinical trials with Notch inhibitors revealed therapeutic challenges, primarily inconsistent efficacy and severe gastrointestinal side effects due to widespread Notch pathway involvement in healthy tissues, especially the gut. tsGPT modeling could have provided early predictions of these differential tissue sensitivities by elucidating the distinct gene-expression signatures induced by Notch inhibition in various cell types. Additionally, tsGPT could identify patient-specific biomarkers to predict responsiveness or toxicity, facilitating personalized dosing strategies or suggesting combination therapies to manage toxicities. The ability of tsGPT to predict tissue-specific therapeutic windows and identify compensatory molecular pathways is therefore particularly valuable here.
        </p>
      </section>
