...
const TherapeuticComplexity: React.FC = () => {
  return (
    <div>
      ...
      <p className="roboto-slab-light text-base mb-6 mt-4 leading-relaxed">
         So, we started by creating a map of the top ~300 successfully approved drugs and organized it by 
        <ul className="text-gray-dark roboto-slab-regular text-xm mt-4">
          <li> 
            - Disease category
          </li>         
          <li> 
      ...
      <p className="roboto-slab-extralight text-xxsm mb-0 mt-2 leading-relaxed">
          The data in the map above was generated by ChatGPT's Deep Research. We double checked many 
      ...
      <p className="roboto-slab-light text-base mt-6 mb-8 leading-relaxed">
        ...
        thanclassical methods have been capable of providing.
