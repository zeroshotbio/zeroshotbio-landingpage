...
export const REASONER_PROMPT = [
  ...
  "",
  "GUT-CHECK BEFORE YOU CONCLUDE: when the call feels settled, first list your key cross-tier assumptions — the lineage/umbrella chain you lean on (e.g. ectoderm ⊃ epidermis ⊃ keratinocyte) and common-sense notions — and if any link is assumed rather than already established, dispatch the Researcher ONCE to confirm that ontology/lineage relationship before concluding. Conclude only once the chain checks out, with confidence reflecting the double-check.",
