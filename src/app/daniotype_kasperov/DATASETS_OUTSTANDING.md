# Outstanding work — ZSCAPE · ChemFish · DanioCell
...
| all three | Version-control the `sources/README.md` files | `raw_datasets/` is not a git repo — provenance records exist on this box only | Not started |
