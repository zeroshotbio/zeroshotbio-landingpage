  ...
  return (
    <>
      ...
      <section>
        ...
        1. The Story of Mylotarg and Off-Target Toxicity</h2>
      ...
      <div className="w-full mb-12">
        ...
        <h3 className="roboto-slab-medium text-lg mb-3">
          How would a biological foundation model like tsGPT have made a difference? 
        </h3>
        <p className="roboto-slab-light mb-6 leading-relaxed">
          A mature transcriptomic modeling approach like tsGPT could have significantly reshaped the story of Mylotarg by anticipating and mitigating its key clinical pitfalls, particularly the unexpected hepatotoxicity arising from CD33 expression on liver-resident Kupffer cells. Leveraging extensive single-cell RNA sequencing data from healthy human tissues alongside AML samples, tsGPT would have quickly identified the problematic off-tumor expression profile of CD33 in liver macrophages. This early identification would have clearly signaled the heightened risk of hepatic veno-occlusive disease (VOD), alerting researchers before clinical trials.
        </p>
        <p className="roboto-slab-light mb-6 leading-relaxed">
          Furthermore, by computationally simulating cellular outcomes following calicheamicin-induced apoptosis in Kupffer cells, tsGPT could have predicted not only the likelihood of liver toxicity but also clarified the biological mechanisms underlying such effects—disruption of hepatic endothelial integrity and inflammatory cascades. With such foresight, drug developers could have proactively adjusted strategies, either by modifying dosing regimens to reduce peak exposure or by revisiting the antibody-drug conjugate&apos;s linker-payload design to limit uptake in non-target cells.
        </p>
        <p className="roboto-slab-light mb-6 leading-relaxed">
          Perhaps the most transformative application of tsGPT, however, would have been its ability to identify alternative therapeutic targets. By systematically screening comprehensive single-cell transcriptomic profiles, the platform could reveal candidate antigens like CLL-1 (CLEC12A), CD123, TIM-3, or FLT3, whose selective AML blast expression coupled with minimal presence on vital healthy tissues presented safer yet equally effective targeting options. Thus, rather than relying solely on CD33, which posed clear transcriptomic red flags, tsGPT&apos;s predictive analytics could have driven researchers towards safer, polygenic targeting strategies, fundamentally shifting the clinical trajectory for Mylotarg. 
        </p>
        <p className="roboto-slab-light mb-24 leading-relaxed">
            In essence, tsGPT would have transformed Mylotarg’s development journey from a reactive process responding to unexpected toxicities into a proactive, transcriptome-guided approach, optimizing therapeutic efficacy and patient safety well before clinical complications emerged.
        </p>
      ...
      <section>
        ...
        <figure className="text-left">
          ...
          />
          <figcaption className="roboto-slab-light text-xsm text-gray-dark mt-4">
          A visualization of the fusion protein responsible for chronic myeolid leukemia, BCR-ABL1.
          </figcaption>
        </figure>
      </div>

        <p className="roboto-slab-light mb-6 leading-relaxed">
          Imatinib (Gleevec) fundamentally transformed the treatment of chronic myeloid leukemia (CML) by directly targeting the BCR-ABL1 tyrosine kinase, a product of the Philadelphia chromosome translocation. BCR-ABL1, a constitutively active enzyme, promotes uncontrolled leukemic cell growth by phosphorylating downstream signaling pathways. Imatinib functions by competitively inhibiting ATP binding to the kinase domain of BCR-ABL1, effectively blocking its activity and halting leukemic proliferation. This mechanism, groundbreaking at its discovery, also extends therapeutic efficacy to other malignancies driven by kinases like c-KIT and PDGFR, such as gastrointestinal stromal tumors. 
        </p>
        <p className="roboto-slab-light mb-6 leading-relaxed">
      ...
      <section>
        ...
        <figure className="text-left">
          ...
          />
          <figcaption className="roboto-slab-light text-xsm text-gray-dark mt-4">
             A visualization of the chemical structure of MK 0752, a γ-secretase inhibitor.
          </figcaption>
        </figure>
      </div>
      ...
      <h3 className="roboto-slab-medium text-lg text-gray-dark mt-28 mb-8">
        To Summarize: How tsGPT Could Transform Leukemia Drug Development Stories
      </h3>

      <p className="roboto-slab-light mb-6 leading-relaxed">
        <strong>Mylotarg (AML)</strong>
        <ul className="list-disc ml-6">
          <li>
            Rapid hypothesis generation on off-target toxicities in healthy tissues, predicting potential hepatotoxicity by evaluating CD33 expression profiles in Kupffer cells before clinical trials.
          </li>
          <li>
            Better guidance on optimal antibody–drug conjugate designs or fractionated dosing regimens, thereby minimizing peak toxicity and improving tolerability.
          </li>
          <li>
            Early identification of alternative antigens (e.g., CLL-1 or CD123) that would reduce the risk of liver damage while still effectively targeting AML blasts.
          </li>
        </ul>
      </p>

      <p className="roboto-slab-light mb-6 leading-relaxed">
        <strong>Imatinib (CML)</strong>
        <ul className="list-disc ml-6">
          <li>
            Early detection of emergent resistance mechanisms by spotting transcriptional signatures tied to kinase domain mutations or alternative signaling pathways.
          </li>
          <li>
            Rapid identification of optimal drug combinations that inhibit parallel survival pathways such as JAK/STAT or PI3K/Akt, preempting clinical resistance.
          </li>
          <li>
            Personalized patient stratification based on scRNA-seq data, allowing clinicians to switch or escalate therapy before overt resistance develops.
          </li>
        </ul>
      </p>

      <p className="roboto-slab-light mb-6 leading-relaxed">
        <strong>Notch Inhibitors (ALL)</strong>
        <ul className="list-disc ml-6">
          <li>
            Fine-grained modeling of safe therapeutic windows, balancing Notch pathway blockade in leukemic cells with the pathway’s essential role in healthy tissues.
          </li>
          <li>
            Early detection of compensatory signaling shifts (e.g., PI3K/Akt, Wnt/β-catenin) that tumors use to bypass Notch inhibition, sparking prompt combination strategies.
          </li>
          <li>
            Patient-specific biomarkers that predict tolerance or response, guiding clinicians in deciding dose schedules and adjunct protective therapies.
          </li>
        </ul>
      </p>
